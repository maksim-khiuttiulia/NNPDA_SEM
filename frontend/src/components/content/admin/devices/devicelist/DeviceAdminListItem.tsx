...
const DeviceAdminListItem: FC<Props> = (props: PropsWithChildren<Props>) => {
    let device: Device = props.device;

    const URL = RouterConstants.adminDevice.replace(":id", String(device.id))
    return (
...
export default DeviceAdminListItem;
