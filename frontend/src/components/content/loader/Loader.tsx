    ...
    return (
        <div className={className}>
            <div className="loader-container">
                <svg className="spinner" stroke="#000" width="200" height="200" viewBox="0 0 206 206"
                    ...
                    <circle className="path" fill="none" strokeWidth="6" strokeLinecap="round" cx="103" cy="103"
                            r="100"/>
                </svg>
